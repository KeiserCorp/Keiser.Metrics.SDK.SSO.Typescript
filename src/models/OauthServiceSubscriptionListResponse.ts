 ...
 */
export function instanceOfOauthServiceSubscriptionListResponse(value: object): value is OauthServiceSubscriptionListResponse {
    if (!('oauthServiceSubscriptions' in value) || value['oauthServiceSubscriptions'] === undefined) return false;
    if (!('oauthServiceSubscriptionsMeta' in value) || value['oauthServiceSubscriptionsMeta'] === undefined) return false;
    return true;
}
