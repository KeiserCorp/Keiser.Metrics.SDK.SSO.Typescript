 ...
 */
export function instanceOfExchangeableUserResponse(value: object): value is ExchangeableUserResponse {
    if (!('exchangeToken' in value) || value['exchangeToken'] === undefined) return false;
    return true;
}
